...
The canonical URI for this version of the extension is: https://github.com/cypherpay/a2a-x402/v0.1
...
```
{
  "capabilities": {
    "extensions": [
      {
        "uri": "https://github.com/cypherpay/a2a-x402/v0.1",
...
`X-A2A-Extensions: https://github.com/cypherpay/a2a-x402/v0.1`
