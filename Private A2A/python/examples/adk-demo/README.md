...
- CypherPay API key (you can create one [here](https://developers.cypherpay.com/docs/api-key))
...
Set your CypherPay API key as an environment variable:
...
*   **Linux/macOS:**
    ```bash
    export CYPHERPAY_API_KEY="your_api_key_here"
    ```
*   **Windows (Command Prompt):**
    ```cmd
    set CYPHERPAY_API_KEY=your_api_key_here
    ```
*   **Windows (PowerShell):**
    ```powershell
    $env:CYPHERPAY_API_KEY="your_api_key_here"
    ```
