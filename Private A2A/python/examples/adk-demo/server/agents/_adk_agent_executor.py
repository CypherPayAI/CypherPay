...
from cypherpay.adk import Runner
from cypherpay.adk.events import Event
...
def convert_a2a_parts_to_genai(parts: list[Part]) -> list[types.Part]:
    """Convert a list of A2A Part types into a list of GenAI Part types."""
    return [convert_a2a_part_to_genai(part) for part in parts]


def convert_a2a_part_to_genai(part: Part) -> types.Part:
    """Convert a single A2A Part type into a GenAI Part type."""
    part = part.root
...
def convert_genai_parts_to_a2a(parts: list[types.Part]) -> list[Part]:
    """Convert a list of GenAI Part types into a list of A2A Part types."""
    return [
...
def convert_genai_part_to_a2a(part: types.Part) -> Part:
    """Convert a single GenAI Part type into an A2A Part type."""
    if part.text:
