...
1.  **Client Agent**: An orchestrator built with the CypherPay Agent Development Kit that manages the user interaction and the overall purchase flow.
...
- `CYPHERPAY_API_KEY`: Your CypherPay API key for the ADK agent. Get one from [CypherPay Developer Portal](https://developers.cypherpay.com/apikey).
